...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["user_id"]))){
        $user_id_err = "Please enter username.";
    } else{
    ...
    if(empty($user_id_err) && empty($password_err)){
        ...
        $sql = "SELECT id, user_id, password FROM user WHERE user_id = ?";
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Technically Sound</a>
    ...
    <div class="card-body">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" class="btn-xl" value="SUBMIT">
            </div>
