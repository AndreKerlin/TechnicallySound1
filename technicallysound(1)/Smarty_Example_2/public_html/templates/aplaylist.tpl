...
<head>
    ...
    <meta charset="UTF-8">
    {*make a php variable or something to say the name*}
    <title>Playlists name</title>
...
<div class="row">
    <div class="col-md-8 offset-md-2">
        {*make a php variable or something to say the name*}
        <h1 class="my-4">Playlist name</h1>
    </div>
</div>
<div class="row">
    <div class="col-md-4 offset-md-8">
        ...
        <div>
        <span>
            <button id="addstuff" class="icon_tag" href="#">Add music to your playlist<i class="mx-2 fas fa-plus"></i></button>
    </span>
    </div>
                                    ...
                                    <form class="form-horizontal" action="send.php" method="post">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="songname">Song name</label>
                                                <div class="col-md-9">
                                                    <input id="songname" name="songname" type="text" placeholder="Add a song" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="artist">Artist</label>
                                                <div class="col-md-9">
                                                    <input id="artist" name="artist" type="text" placeholder="Add an artist" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="album">Album</label>
                                                <div class="col-md-9">
                                                    <input id="album" name="album" type="text" placeholder="Add an album" class="form-control">
                                                </div>
                                            </div>
...
<script>// Get the modal
    ...
    var btn = document.getElementById("addstuff");
...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <ul class="list-group">
            ...
            <a class="icon_tag" href="#"><i class="mx-2 fas fa-minus-circle"></i></a>
            </span>
            </li>
            {/foreach}
        </ul>
